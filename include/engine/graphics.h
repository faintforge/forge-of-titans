...
extern Color color_rgba_f(f32 r, f32 g, f32 b, f32 a);
extern Color color_rgba_i(u8 r, u8 g, u8 b, u8 a);
extern Color color_rgba_hex(u32 hex);
extern Color color_rgb_f(f32 r, f32 g, f32 b);
extern Color color_rgb_i(u8 r, u8 g, u8 b);

extern Color color_rgb_hex(u32 hex);
extern Color color_hsl(f32 hue, f32 saturation, f32 lightness);
extern Color color_hsv(f32 hue, f32 saturation, f32 value);
...
extern void gfx_clear(Color color);
